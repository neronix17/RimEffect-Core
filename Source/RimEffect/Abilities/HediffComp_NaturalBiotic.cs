namespace RimEffect
{
    ...
    public class HediffComp_NaturalBiotic : HediffComp
    {
        ...
        public override void CompPostMake()
        {
            ...
            if (HediffMaker.MakeHediff(RE_DefOf.RE_BioticAmpHediff, this.Pawn, this.Pawn.RaceProps.body.GetPartsWithDef(BodyPartDefOf.Brain).FirstOrFallback()) is Hediff_Abilities implant)
            {
                implant.Severity            = 0f;

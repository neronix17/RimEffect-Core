...
namespace RimEffect
{
	public class Window_GalaxyMap : Window
	{
		...
		public Window_GalaxyMap(QuestGiverManager questGiverManager)
		{
			this.questGiverManager = questGiverManager;
			this.questInfos = questGiverManager.AvailableQuests;
		...
		public override void DoWindowContents(Rect rect)
		{
			...
			Widgets.Label(availableContractsRect, "RE.AvailableContracts".Translate(this.questGiverManager.AvailableQuests.Count));
		...
		private void DoRow(Rect rect, QuestInfo questInfo)
		{
			...
			var factionIconRect = new Rect(rect4.x + 7f + (4 * 15f), rect.y + 2, rect.height - 4, rect.height - 4);
